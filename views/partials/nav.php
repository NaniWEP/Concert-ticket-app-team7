<nav class=" border-gray-200 dark:bg-gray-900 bg-[#202124] w-full">
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl px-4 md:px-6 py-2.5 ">
        ...
        <div class="relative">
            ...
            <input type="search" id="default-search" class="block w-96 p-2 pl-10 text-sm text-gray-900  border
             border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700
              dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500
               dark:focus:border-blue-500" placeholder="Search Mockups, Logos..." required>
            
        </div>
        </div>
        <div class="flex items-center">
            
            <img src="/assets/cart.png" class="w-10 mr-8" alt="">
            <img src="/assets/account.png" class="w-8" alt="">
        </div>
    </div>
