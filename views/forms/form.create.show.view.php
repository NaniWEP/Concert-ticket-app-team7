  ...
  <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
    ...
    <form action="" method="post" enctype="multipart/form-data" >
          <div class="relative z-0 w-full mb-5">
            <input type="text"  name="title" placeholder=" " value='<?php echo isset($_POST['title']) ? $_POST['title'] : ''; ?>'
        ...
        <div class="flex space-x-4">
          ...
          <div class="relative z-0 w-full mb-5">
            <select name="type-id"  onclick="this.setAttribute('value', this.value);"
              ...
              <option value="1" <?php echo (isset($_POST['type-id']) && $_POST['type-id'] === '1') ? 'selected' : ''; ?>>Movie </option>
              <option value="2" <?php echo (isset($_POST['type-id']) && $_POST['type-id'] === '2') ? 'selected' : ''; ?>>Concert</option>
            </select>
          ...
          <div class="flex flex-row space-x-4">
            ...
            <div class="relative z-0 w-full">
              <input type="text"  name="time" placeholder=" " onclick="this.setAttribute('type', 'time') " value='<?php echo isset($_POST['time']) ? $_POST['time'] : ''; ?>'
                class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
