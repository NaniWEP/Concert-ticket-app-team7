  ...
  <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
    ...
    <!-- enctype="multipart/form-data" -->
          <div class="relative z-0 w-full mb-5">
            <input type="text"  name="title" value='<?php echo isset($_POST['title']) ? $_POST['title'] : $title;?>'
        ...
        <div class="flex space-x-4">
            <div class="relative z-0 w-full mb-5">
              <input type="text" name="language"   value='<?php echo isset($_POST['language']) ? $_POST['language'] : $language ;?>'
                class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
            ...
            <div class="relative z-0 w-full mb-5 ">
              <input type="text" name="subtitle"   value='<?php echo isset($_POST['subtitle']) ? $_POST['subtitle'] : $subtitle; ?>'
                class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
          ...
          <div class="flex flex-row space-x-4">
            <div class="relative z-0 w-full mb-5">
              <input type="text" name="date" onclick="this.setAttribute('type', 'date');" value='<?php echo isset($_POST['date']) ? $_POST['date'] : $date; ?>'
                class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
          ...
          <div class="relative z-0 w-full mb-5">
            <input type="number"  name="running-time" value='<?php echo isset($_POST['running-time']) ? $_POST['running-time'] : $runningTime; ?>'
            class="pt-3 pb-2   block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
          ...
          <div class="relative z-0 w-full mb-5">
            <input type="text" name="trailer" value='<?php echo isset($_POST['trailer']) ? $_POST['trailer'] : $trailer; ?>'
              class="pt-3 pb-2 pr-12 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
