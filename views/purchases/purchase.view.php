                ...
                <form method="post" class="flex flex-col justify-center items-center flex-wrap gap-3 w-full p-5">
                    <div class="w-full">
                        <label class="relative w-full flex flex-col">
                            ...
                            <input type="text" id="ownerName" name="ownerName"  placeholder="Owner Name" value="<?= isset($_POST['ownerName']) ? $_POST['ownerName'] : ''; ?>" class=" w-full rounded-md peer pl-12 pr-2 py-2 border border-gray-200 placeholder-gray-500 focus:border-black focus:ring-red-300 focus:outline-none focus:ring focus:ring-opacity-40 <?= $colorErrorOwnerName ? "border-[#B60505]" : "" ?>"  />
